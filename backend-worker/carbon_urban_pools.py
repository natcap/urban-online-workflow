...
This is a modified copy of natcap.invest.carbon.py tag=3.14.1.
This version has been modified to include the urban carbon pools
'c_emissions' and 'c_embedded'.
...
CARBON_OUTPUTS = {
    f"c_{scenario}_{pool}.tif": {
        ...
        ('soil', 'soil'),
        ('dead', 'dead matter'),
        ('embedded', 'urban_embedded'),
        ('emissions', 'urban_emissions')
        ...
        "carbon_pools_path": {
            ...
            "columns": {
                ...
                "c_embedded": {
                    "type": "number",
                    "units": u.metric_ton/u.hectare,
                    "about": gettext("Carbon density of urban embedded.")},
                "c_emissions": {
                    "type": "number",
                    "units": u.metric_ton/u.hectare,
                    "about": gettext("Carbon density of urban emissions.")}
            },
            "index_col": "lucode",
            "about": gettext(
...
def execute(args):
    ...
    pool_names = [
        'c_above', 'c_below', 'c_soil', 'c_dead', 'c_embedded', 'c_emissions']
